...
void ExternalProcessing::Initialize(int sample_rate_hz, int num_channels) {
  ...
  ::syslog(LOG_INFO, "EXTERNAL-CIT: ExternalProcessing #Init; external_processor: %p", (void*)external_processor);
...
void ExternalProcessing::Process(webrtc::AudioBuffer* audio) {
  ...
  ::syslog(LOG_INFO, "EXTERNAL-CIT: ExternalProcessing #Process; external_processor: %p", (void*)external_processor);
