...
import io.getstream.webrtc.EncodedImage;
import io.getstream.webrtc.EncodedImage.FrameType;
import io.getstream.webrtc.FakeMediaCodecWrapper.State;
import io.getstream.webrtc.Logging;
import io.getstream.webrtc.VideoCodecStatus;
import io.getstream.webrtc.VideoEncoder;
import io.getstream.webrtc.VideoEncoder.BitrateAllocation;
import io.getstream.webrtc.VideoEncoder.CodecSpecificInfo;
import io.getstream.webrtc.VideoEncoder.EncodeInfo;
import io.getstream.webrtc.VideoEncoder.Settings;
import io.getstream.webrtc.VideoFrame;
import io.getstream.webrtc.VideoFrame.Buffer;
import io.getstream.webrtc.VideoFrame.I420Buffer;
  ...
  private class TestEncoderBuilder {
    ...
    public TestEncoder build() {
      return new TestEncoder((String name)
          ...
          "io.getstream.webrtc.testencoder", codecType,
