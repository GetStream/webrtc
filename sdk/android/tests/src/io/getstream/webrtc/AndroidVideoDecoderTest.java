...
import io.getstream.webrtc.VideoDecoder.DecodeInfo;
import io.getstream.webrtc.VideoFrame.I420Buffer;
import io.getstream.webrtc.VideoFrame.TextureBuffer.Type;
  ...
  private class TestDecoderBuilder {
    ...
    public TestDecoder build() {
      return new TestDecoder((String name)
          ...
          /* codecName= */ "io.getstream.webrtc.testdecoder", codecType, COLOR_FORMAT,
